  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        {/* Brand */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">Khamar<span className="text-blue-500"> MarketPlace</span></h2>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>made for Khamar MarketPlace dont use otherwise approval of admin</span>
            </li>
      ...
      <div className="border-t border-gray-800 pt-8 text-center text-xs text-gray-500">
        <p>&copy; {new Date().getFullYear()} Khamar MarketPlace Inc. All rights reserved.</p>
      </div>
    </footer>
  );
}
