...
import { Star, ShoppingCart, Heart, Share2, Truck, RotateCcw, ShieldCheck, CheckCircle } from "lucide-react";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
      ...
      <div className="space-y-4">
        <div className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden border">
          <Image src={selectedImage || "/placeholder.png"} alt={product.name} fill className="object-cover" />
      ...
      <div>
        ...
        <div className="flex gap-4 mb-8">
          ...
          <button 
            onClick={() => { addToWishlist({ id: product.id, name: product.name, price: product.price, image: product.images[0], quantity: 1 }); toast.success("Added to Wishlist"); }}
